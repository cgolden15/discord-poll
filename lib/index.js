...
async function poll(message, args, separator, embedColor, emoji) {
    ...
    if (findSep === undefined) {
        ...
        message.delete();
        const embed = new discord_js_1.default.MessageEmbed().setTitle(`${emoji} ` + question).setColor(embedColor);
